...
public class LevelSelectScreen2 extends AbstractScreen {
	...
	public LevelSelectScreen2() {
		...
		TextButton button7 = new TextButton("NEXT WORLD", skin);
		...
		table.add(button7).padLeft(100);		
		table.row();
		
		TextButton button8 = new TextButton("BACK", skin);
